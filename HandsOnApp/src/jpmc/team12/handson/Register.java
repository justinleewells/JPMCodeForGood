...
//**Initialize the error images**//
	...
	private class CreateUserClickListener implements OnClickListener {
		...
		public void onClick(View v) {
			...
			String reenteredPassword = mReenterPasswordEdit.getText().toString();
			...
			if(!password.equals(reenteredPassword)){
				...
				//Toast.makeText(mContext, R.string.new_password_mismatch, Toast.LENGTH_SHORT).show();
			...
			/*
				...
				try {
					...
					Toast.makeText(mContext, R.string.user_exists, Toast.LENGTH_SHORT).show();
					usernamee.setVisibility(View.VISIBLE);
					return;
				}
